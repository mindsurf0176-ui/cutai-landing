      ...
      <nav className="border-b border-white/5 bg-black/50 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 font-bold text-xl tracking-tight">
            <img src="/icon.svg" className="w-8 h-8" alt="CutAI Logo" />
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-zinc-900/50 border border-white/5 p-8 rounded-2xl">
              <div className="w-12 h-12 rounded-xl bg-zinc-800 flex items-center justify-center text-2xl font-bold mb-6">1
            ...
            <div className="bg-zinc-900/50 border border-white/5 p-8 rounded-2xl relative">
              ...
              <div className="w-12 h-12 rounded-xl bg-blue-900/50 text-blue-400 flex items-center justify-center text-2xl font-bold mb-6 border border-blue-500/20">2
            ...
            <div className="bg-zinc-900/50 border border-white/5 p-8 rounded-2xl relative">
              <div className="hidden md:block absolute top-12 -left-4 w-8 h-px bg-white/20" />
              <div className="w-12 h-12 rounded-xl bg-zinc-800 flex items-center justify-center text-2xl font-bold mb-6">3
